...
#                 logger.info(f"Loaded repo config: owner='{self.repo_owner}', repo='{self.repo_name}'")
...
#                 # Create enhanced system instruction with repo info
#                 repo_info = ""
#                 if self.repo_owner and self.repo_name:
#                     repo_info = f"""
# The user's primary repository is: {self.repo_owner}/{self.repo_name}
# When they ask about "my repo" or "my repository", use these values for owner and repo parameters.
# """
...
# {repo_info}
# When users ask about "my repositories" or similar, use the appropriate GitHub tools to get the information."""
...
#         logger.info(f"Auto-fill values: owner='{owner}', repo='{repo}'")
...
#         if 'owner' in props and not parameters.get('owner') and owner:
#             parameters['owner'] = owner
#             logger.info(f"Auto-filled owner parameter: {owner}")
        
#         # Auto-fill repo parameters if needed and available
#         for param in repo_param_names:
#             if param in props and not parameters.get(param) and repo:
#                 parameters[param] = repo
#                 logger.info(f"Auto-filled {param} parameter: {repo}")
